...
class F1RacePredictor:
    ...
    def extract_weekend_features(self, gp_name):
        ...
        team_sectors['TeamIdealLap'] = (
            team_sectors['Sector1Time']
            + team_sectors['Sector2Time']
            + team_sectors['Sector3Time']
        )
        team_sectors = team_sectors[['Team', 'TeamIdealLap']]
        ...
        teams = (
            team_quali.merge(team_sectors, on='Team', how='outer')
    ...
    def prepare_features_for_ml(self, quali_runs, race_runs, stats, team_data):
        ...
        if 'TeamIdealLap' in features:
            features['team_sector_gap'] = features['TeamIdealLap'] - features['BestLap']
        else:
            features['team_sector_gap'] = 0
        return features

...
class F1RacePredictor:
    ...
    def extract_weekend_features(self, gp_name):
        ...
        teams = team_quali.merge(team_race, on='Team', how='outer').merge(team_stats, on='Team', how='outer')
    ...
    def prepare_features_for_ml(self, quali_runs, race_runs, stats, team_data):
        ...
        team_cols = ['TeamBestLap', 'TeamAvgLap', 'TeamMedianLap', 'TeamLapStd', 'TeamNumLaps']
        for c in team_cols:
            if c in features:
